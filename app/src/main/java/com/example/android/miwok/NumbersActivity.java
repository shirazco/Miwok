...
public class NumbersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] defaultWords = {"one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten"};
        String[] miwokWords = {"lutti", "otiiko", "tolookosu", "oyyisa", "massokka", "temmokka", "kenekaku", "kawinta", "wo'e", "na'aacha"};
        ...
        int[] audios = {R.raw.number_one, R.raw.number_two, R.raw.number_three, R.raw.number_four, R.raw.number_five, R.raw.number_six ,R.raw.number_seven, R.raw.number_eight, R.raw.number_nine, R.raw.number_ten};

        final ArrayList<Word> numbersWords = new ArrayList<Word>();
        for(int i=0; i<defaultWords.length; i++){
            numbersWords.add(new Word(defaultWords[i], miwokWords[i], images[i], audios[i]));
        }
